...
SUPPLIERS = [
    {
        ...
        "switching_cost": 0,
        "note": "H100/H200/B200受美国出口管制。2025年腾讯坦承'买不到卡'，资本开支仅¥792亿远低于字节¥1,500亿",
    },
    {
        "name": "华为昇腾(AI芯片-备选)",
...
KPI_TARGETS = {
    ...
    "ai_capex_ratio": {
        ...
        "threshold": 0.08,
        "unit": "%",
        "note": "2025年资本开支¥792亿(10.5%)，低于字节¥1,500亿(21%)。管理层坦承'买不到卡'。",
    },
    "gross_margin": {
        "name": "毛利率",
        "actual": 0.56,
    ...
    "user_time_share": {
        ...
        "threshold": 0.28,
        "unit": "%",
        "note": "2026.1腾讯系30.0%首次被字节系37.4%超越。须通过视频号+元宝拉回时长。",
    },
}
